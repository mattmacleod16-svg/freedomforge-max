...
async function fetchPrices(assets) {
  ...
  // Batch CoinGecko (can query multiple at once)
  const assetMap = {
    BTC: 'bitcoin', ETH: 'ethereum', SOL: 'solana', XRP: 'ripple',
    ADA: 'cardano', DOT: 'polkadot', AVAX: 'avalanche-2', LINK: 'chainlink',
    MATIC: 'matic-network', DOGE: 'dogecoin', ATOM: 'cosmos', UNI: 'uniswap',
  };

  // First try Kraken for all (parallel)
