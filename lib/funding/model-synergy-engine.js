...
const MODEL_STRENGTHS = {
  ...
  perplexity: {
    ...
    costTier: 'low',       // sonar base is cheap ($1/$1 per M tokens)
    speedTier: 'fast',
    contextWindow: 127072,
    bestFor: ['What is the current price of...', 'Latest news about...', 'Quick fact check on...'],
    variants: {
      'sonar':               { costTier: 'low',    speedTier: 'fast',   contextWindow: 127072, bestFor: 'Quick search, fact checks, current prices' },
      'sonar-pro':           { costTier: 'medium', speedTier: 'medium', contextWindow: 200000, bestFor: 'Complex multi-step research, deep analysis' },
      'sonar-reasoning-pro': { costTier: 'medium', speedTier: 'slow',   contextWindow: 200000, bestFor: 'Chain-of-thought reasoning, logical analysis' },
      'sonar-deep-research': { costTier: 'high',   speedTier: 'slow',   contextWindow: 128000, bestFor: 'Exhaustive multi-step web research, market reports' },
    },
  },
};
