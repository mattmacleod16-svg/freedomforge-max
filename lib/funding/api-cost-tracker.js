...
const PRICING = {
  ...
  'perplexity':              { perUnit: 0.001,   unit: '1k_tokens', category: 'ai' },  // sonar (lightweight)
  'perplexity_sonar_pro':    { perUnit: 0.009,   unit: '1k_tokens', category: 'ai' },  // sonar-pro (advanced search)
  'perplexity_reasoning':    { perUnit: 0.009,   unit: '1k_tokens', category: 'ai' },  // sonar-reasoning-pro (CoT)
  'perplexity_deep_research':{ perUnit: 0.005,   unit: '1k_tokens', category: 'ai' },  // sonar-deep-research (multi-step)
  'perplexity_search_api':   { perUnit: 0.005,   unit: 'request',   category: 'data' }, // raw search API
