...
const FLASH_CRASH_THRESHOLD_PCT = Number(process.env.EDGE_FLASH_CRASH_PCT || 8);
// Runaway loss: max acceptable drawdown velocity (dollars per hour)
const RUNAWAY_LOSS_VELOCITY_USD_HR = Number(process.env.EDGE_RUNAWAY_VELOCITY_USD_HR || 50);
// Overfit: live Sharpe must be at least this fraction of backtest Sharpe
const OVERFIT_SHARPE_FLOOR_RATIO = Number(process.env.EDGE_OVERFIT_SHARPE_FLOOR || 0.3);
...
const GAS_SPIKE_THRESHOLD_GWEI = Number(process.env.EDGE_GAS_SPIKE_GWEI || 100);
