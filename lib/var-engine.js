 ...
 * @returns {{ var95: number, var99: number }}
...
function getCorrelation(matrix, assetA, assetB) {
  ...
  return 0; // unknown pairs assumed uncorrelated (conservative for sizing)
}
...
// ══════════════════════════════════════════════════════════════════════════════
// 8. Enhanced Risk Check (VaR overlay on risk-manager)
// ══════════════════════════════════════════════════════════════════════════════
