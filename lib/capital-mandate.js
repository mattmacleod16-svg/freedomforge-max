 ...
 *   4. Compounding Mandate — ALL profits are reinvested. No withdrawals. Period.
 ...
 *
 * The system starts with ~$455 combined (CB ~$281 + KR ~$174).
...
const MILESTONES = [500, 750, 1000, 2000, 5000, 10000, 25000, 50000, 100000];
...
function createInitialState() {
  return {
    initialCapital: 508, // CB ~$334 + KR ~$174 — THE ONLY CAPITAL. EVER. Final deposit confirmed.
...
function getMandateSummary() {
  ...
  return {
    ...
    mandateActive: true,
    message: 'ZERO INJECTION PROTOCOL — No external capital. Self-sufficient or bust.',
  };
}
